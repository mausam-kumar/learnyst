        ...
        <div className="max-w-xl w-full">
            ...
            <div className="relative mt-2 flex items-center">
                <input
                    ...
                    className="block px-4 w-full rounded-md border-0 py-1.5 pr-14 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 sm:text-sm sm:leading-6"
                />
            </div>
        </div>
    )
